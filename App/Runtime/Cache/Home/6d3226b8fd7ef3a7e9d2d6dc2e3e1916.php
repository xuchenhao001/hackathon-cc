        ...
        <form name="myForm" class="form-horizontal" enctype="multipart/form-data">
            <fieldset ng-controller="RegistrationController">
                ...
                <div class="form-group">
                    <label class="col-md-5 col-sm-4 col-xs-3 control-label" for="UserName"> Traffic Control Department Name
                    </label>
                    ...
                    <div ng-show="nameNotValid">
                        <label  style="color:red" name ="usernameFiled">Field Traffic Control Department Name can not be empty</label>
                    </div>
                </div>
                ...
                <!-- Address input-->
                <div class="form-group">
                    <label class="col-md-5 col-sm-4 col-xs-3 control-label" for="Address"> Traffic Control Department Address
                    </label>
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <input id="Address" name="Address" type="text" placeholder="enter your Traffic Control Department Address" ng-model="shopaddress" class="form-control input-sm input.ng-invalid" required>
                    </div>
                    <div ng-show="nameNotValid">
                ...
                <!-- Textarea -->
                <div class="form-group">
                    <label class="col-md-5 col-sm-4 col-xs-3 control-label" for="textarea">Description of Traffic Control Department.</label>
                    <div class="col-md-2 col-sm-4 col-xs-6">
