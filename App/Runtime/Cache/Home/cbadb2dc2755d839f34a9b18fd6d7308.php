...
<body style="background-image: url(../../Public/img/back.jpg) ">
<!-- navbar -->
            ...
            <div class="container">
                ...
                <nav class="pull-right nav-collapse collapse">
                    <ul id="menu-main" class="nav">
                        <li><a title="services" href="/home/index/returnHome">Home</a></li>
                        <li><a href="/home/index/returnHome">Logout</a></li>
                    </ul>
                </nav>
            </div>
        </div>
...
<!--展示主要的界面-->
<div class="dx-viewport" style="padding: 50px">
    <div class="row" style="margin-top: 100px">
        <div class="dx-viewport demo-container">

            <div class="dx-field" >
                <div  style="display: inherit">Datetime</div>
                <div style="width: 300px;height: 50px">
                    <div id="date-time" style="height: 50px"></div>
                </div>
            </div>
            <div class="dx-field">

                <div style="width: 200px">
                    <div id="place" style="display: inline">
                        <label style="float: left;display: inline;color: #ee5f5b;">Place:
    ...
    <div class="dx-field" style="float: left;">
        <div class="dx-field-value" style="width: 100px;height: 50px">
            <div id="success"><a target="_blank" class="but" >Search</a></div>
        </div>
    </div>
...
<script src="/Public/js/searchcar.js"></script>
<!-- nav -->
