...
<ul class="list-group">
    ...
    <li class="list-group-item">
        <div class="row-fluid">
            ...
            <div >
                <div id="tourid" hidden><?php echo ($FromUserName); ?></div>
                <div id="order_id" hidden><?php echo ($tour_order_id); ?></div>
            </div>
            <div class="col-xs-6 span3">
                <dl >
                    <script>

                        var nickname=unescape(unescape(<?php echo ($nickname); ?>));
    ...
    <li class="list-group-item">
        ...
        <div class="row-fluid">
            <div class="col-xs-5 span3">
                <dl>
                    <dd id="order_time"><?php echo ($order_time); ?></dd>
                    <dd ><label id="teamnumber"><?php echo ($teamnumber); ?></label>人</dd>
                    <dd><label id="receive_together"> <?php echo ($receive); ?></label></dd>
                </dl>
            ...
            <div class="col-xs-5 span3">
               <dl>
                   <dd id="spendmoney"><?php echo ($spendmoney); ?>元</dd>
    ...
    <button id="getOrder" type="button" class="btn btn-block btn-success" onclick="guide_rece()" >立即抢单</button>
    <button id="startravel" type="button" class="btn btn-block btn-success" onclick="guide_start_travel()"  style="display: none;">GO</button>
