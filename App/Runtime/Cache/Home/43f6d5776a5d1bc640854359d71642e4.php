...
<div class="container">
        ...
        <form name="myForm" class="form-horizontal" enctype="multipart/form-data">
            <fieldset ng-controller="RegistrationController">
                ...
                <div class="form-group">
                    <label class="col-md-5 col-sm-4 col-xs-3 control-label" for="UserName"> Garage Name
                    </label>
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <input id="username" name="username" type="text"
                               placeholder="enter your garage name" ng-model="username"
                               class="form-control input-sm input.ng-invalid" required>
                        <p class="required" id="usernameError"></p>
                    </div>
                    <div ng-show="nameNotValid">
                        <label style="color:red" >Field Insurance Name can not be empty</label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        ...
                        <input id="Telephone" name="Telephone" type="text"
                               pattern="^([0|\+[0-9]{1,5})?([1-9][0-9]{10})$" placeholder="enter your Telephone"
                               ng-model="phoneNumber" class="form-control input-sm" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <input id="Address" name="Address" type="text" placeholder="enter your Garage Address"
                               ng-model="shopaddress" class="form-control input-sm input.ng-invalid" required>
                    </div>
                    <div ng-show="nameNotValid">
                ...
                <!-- Textarea -->
                <div class="form-group">
                    <label class="col-md-5 col-sm-4 col-xs-3 control-label" for="textarea">Description of your
                        garage.</label>
                    <div class="col-md-2 col-sm-4 col-xs-6">
    ...
    <script type="text/javascript">
        function register() {
            ...
            $.post('/home/garage/register',data,function (response) {
                $.cookie('type', "garage");
