        ...
        <form name="myForm" class="form-horizontal" enctype="multipart/form-data">
            <fieldset ng-controller="RegistrationController">
                ...
                <div class="form-group">
                    <label class="col-md-5 col-sm-4 col-xs-3 control-label" for="UserName"> Car ID
                    </label>
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <input id="username" name="username"  onFocus = "TipForUsername()" type="text" placeholder="enter your Car ID" ng-model="username" class="form-control input-sm input.ng-invalid" required>
                ...
                <!-- Address input-->
                <div class="form-group">
                    <label class="col-md-5 col-sm-4 col-xs-3 control-label" for="Address"> Identity Card Number
                    </label>
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <input id="Address" name="Address" type="text" placeholder="enter your Identity Card Number" ng-model="shopaddress" class="form-control input-sm input.ng-invalid" required>
                    </div>
                    <div ng-show="nameNotValid">
